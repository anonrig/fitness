<?
	...
	$allComments = FitnessProgram::getAdminComments();
			...
			<div class="navigation-block">
				...
				<nav class="main-navigation" role="navigation">
					<ul>
						...
						<li class="current"><a href="comments.php" class="no-submenu"><span class="awe-table"></span>All Comments</a></li>
					</ul>
				</nav>
				<!-- /Main navigation -->
										...
										<tbody>
					                        ...
					                        foreach ($allComments as $value) {
											    ...
											    echo "<tr class=\"odd gradeA\">
														...
														<td>$nameInfo</td>
														<td>$commentInfo</td>
														<td><p class=\"trashComment\" class=\"btn btn-danger\" id=\"$commentId\">Delete</p></td>
														<td><a href=\"edit.php?type=comment&id=$commentId\">Edit</a>
													</tr>";
