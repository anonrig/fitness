			...
			<div class="navigation-block">
				...
				<nav class="main-navigation" role="navigation">
					<ul>
						...
						<li class="current"><a href="users.php" class="no-submenu"><span class="awe-table"></span>All Users</a></li>
										...
										<?
					                        ...
					                        foreach ($users as $value) {
											    ...
											    echo "<tr class=\"odd gradeA\">
														...
														<td>$emailInfo</td>
														<td>$genderInfo</td>
														<td><a href=\"edit.php?type=user&id=$idInfo\">Edit</a></td>
														<td style=\"width: 135px;\"><a class=\"btn btn-danger btn-flat disableUserBtn\">Disable</a>
																					<a class=\"btn btn-primary btn-flat pull-right enableUserBtn\">Enable</a></td>
													</tr>";
