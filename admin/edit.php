				...
				<div class="row">
					...
					<article class="span12 data-block decent">
						<div class="data-container">
							<? if ($pageType == "user") { $currentUser = User::getUserByUserId($pageId);?>
							<section>
									...
									<fieldset>
										<div class="control-group">
											...
											<div class="form-controls demo">
												<input type="hidden" id="<?php echo $pageId; ?>" class="adminedituserid" />
												<label data-icon="u" for="namesignup">Name</label>
												<input class="input-medium" type="text" value="<?php echo $currentUser->getName(); ?>">
												
												<label data-icon="u" for="namesignup">Username</label>
												<input class="input-medium" type="text" value="<?php echo $currentUser->getUserName(); ?>">

												<label data-icon="u" for="namesignup">E-mail</label>
												<input class="input-medium" type="text" value="<?php echo $currentUser->getEmail(); ?>">


												<label data-icon="u" for="namesignup">Image Url</label>
												<input class="input-medium" type="text" value="<?php echo $currentUser->getPicture(); ?>">

												<label data-icon="u" for="namesignup">Age</label>
												<input class="input-medium" type="text" value="<?php echo $currentUser->getAge(); ?>">

												<label data-icon="u" for="namesignup">Height</label>
												<input class="input-medium" type="text" value="<?php echo $currentUser->getHeight(); ?>">

												<label data-icon="u" for="namesignup">Mass</label>
												<input class="input-medium" type="text" value="<?php echo $currentUser->getMass(); ?>">

												<label data-icon="u" for="namesignup">Experience</label>
												<input class="input-medium" type="text" value="<?php echo $currentUser->getExperience(); ?>">

												<label data-icon="u" for="namesignup">Fat Percentage</label>
												<input class="input-medium" type="text" value="<?php echo $currentUser->getFatPercentage(); ?>">
												...
												<input class="input-large" type="text" value="<?php echo $currentUser->getBio(); ?>">

												<a href="#" id="editadminuser" class="btn btn-primary btn-flat pull-left" style="margin-bottom:2%;">Submit</a>
							...
							<? } else if ($pageType == "comment") { $currentComment = FitnessProgram::getAdminCommentById($pageId);  ?>
							<section>
								<form class="form-inline">
									<fieldset>
										<div class="control-group">
											<label data-icon="u" for="commenttext">Comment Text</label>
											<div class="form-controls demo">
												<? foreach ($currentComment as $value) { $comment = $value['comment_text']; ?>
													
												<input type="hidden" value="<? echo $pageId; ?>" class="admincommentid" />
												<input class="input-medium" type="text" value="<?php echo $comment; ?>">
												
												<? } ?>
												

												<a href="#" id="editadmincomment" class="btn btn-primary btn-flat pull-left" style="margin-bottom:2%;">Submit</a>
							...
							<? } else if ($pageType == "program") { $currentFitness = FitnessProgram::getFitnessProgramById($pageId); ?>
							<section>
								<form class="form-inline">
									<fieldset>
										<div class="control-group">
											...
											<div class="form-controls demo">
												<input type="hidden" value="<? echo $pageId; ?>" class="adminprogramid" />
												<label data-icon="u" for="namesignup">Title</label>
												<input class="input-medium" type="text" value="<? echo $currentFitness->getTitle(); ?>">
												
												<label data-icon="u" for="namesignup">Detail</label>
												<input class="input-medium" type="text" value="<? echo $currentFitness->getDetails(); ?>">

												<a href="#" id="editadminprogram" class="btn btn-primary btn-flat pull-left" style="margin-bottom:2%;">Submit</a>
