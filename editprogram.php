<? require_once("./func.php");
	...
	$currentFitness = $currentUser->getFitnessProgram();
	
	printHeader("Edit your fitness program");
...
<body class="redScheme">
    ...
    <div class="pageInfo">
        ...
        <div class="container">
            ...
            <div class="eight columns pageTitle">
                ...
                <h1>EDIT YOUR FITNESS PROGRAM</h1>
            ...
            <div class="eight columns breadcrumb">
               ...
               <span>EDIT YOUR FITNESS PROGRAM</span>
        ...
        <div class="container">
            ...
            <div class="sixteen columns">
                ...
                <div class="pageContent">
                        ...
                        <h4 style="margin-bottom: 15px;">EDITING YOUR FITNESS PROGRAM</h4>
                            
                        <p>Edit your program</p>
                        <br>
                        <br>
                        <div id="editstepOne">
                          <div>
                          	<input type="hidden" class="programhidden" id="<? echo $currentFitness->getProgramId(); ?>"
                            <label for="exerciseName">Title For Your Program</label>
                            <input type="text" name="exerciseName" id="exerciseName"  required="required" maxlength="40" placeholder="<? echo $currentUser->getFitnessProgram()->getTitle(); ?>"></input>
                          </div>
                          <div>
                            <label for="exerciseName">Detailed Info For Your Program</label>
                            <textarea id="editarea" placeholder="<? echo $currentUser->getFitnessProgram()->getDetails(); ?>"></textarea>
                          </div>
                           <p class="exbuttons button-small red rounded3 editbuttonsfirst" id="editstepOneButton">Go to Next Step Without Saving</p>
                            <p class="exbuttons button-small red rounded3 editbuttonsfirst" id="saveStepOne">Save Information</p>
                        </div>
   ...
   <? printFooter(); ?>
   <script type="text/javascript" src="javascript/editprogram.js"></script>